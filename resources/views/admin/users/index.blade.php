                      ...
                      <tr>
                        ...
                        <td class="align-middle">
                          <a
                            ...
                            data-toggle="tooltip"
                            data-original-title="Delete user" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $section->id }}').submit();">
                            Delete
                          </a>
                          <!-- Delete Form -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('sections.store') }}">
                    ...
                    <div class="form-group">
                        <label for="sectionFunction">Section Function</label>
                        <input type="text" class="form-control" id="sectionFunction" name="function" required>
                    </div>
                    <div class="form-group">
                        <label for="sectionStatus">Section Status</label>
                        <select class="form-control" id="sectionStatus" name="status" required>
