                        ...
                        <div class="input-group input-group-outline row my-3">
                            ...
                            <div class="col-md-9">
                                <select name="user_id" id="user_id" required class="form-control select2">
                                    ...
                                    <option value="{{ $user->id }}" {{ $user->id == $invoice->user_id ?
                        ...
                        <div class="input-group input-group-outline row my-3">
                            ...
                            <div class="col-md-9">
                                <select name="project_id" id="project_id" required class="form-control select2">
                                    ...
                                    <option value="{{ $project->id }}" {{ $project->id == $invoice->project_id ?
                        ...
                        <div class="input-group input-group-outline row my-3">
                            ...
                            <div class="col-md-9">
                                <select name="currency" id="currency" required class="form-control select2">
                                    ...
                                    <option value="{{ $currency }}" {{ $currency==$invoice->currency ? 'selected' :''
                                        }}>{{
                                        $currency }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="input-group input-group-outline row my-3">
                            ...
                            <div class="col-md-9">
                                <input id="rate" type="number" class="form-control @error('rate') is-invalid @enderror"
                                    name="rate" value="{{ $invoice->rate }}" min="0" step="any">
                        ...
                        <div class="input-group input-group-outline row my-3">
                            ...
                            <div class="col-md-9">
                                <input id="due_date" type="date"
                                    ...
                                    required autocomplete="due_date" value="{{ $invoice->due_date ?? date('Y-m-d') }}">
                        ...
                        <div class="input-group input-group-outline row my-3">
                            ...
                            <div class="col-md-9">
                                <select name="status" id="status" required class="form-control select2">
                                    ...
                                    <option value="{{ $status }}" {{ $status==$invoice->status ? 'selected' :'' }}>{{
                                        $status }}</option>
                                    @endforeach
                                </select>
                            </div>
