                        ...
                        <form action="{{ route('orders.update', $order->id) }}" method="post">
                                ...
                                <tbody class="order-list">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" name="products[{{ $product->id }}][quantity]"
                                                data-price="{{ number_format($product->unit_price, 2) }}"
                                                class="form-control" min="1" value="{{ $product->pivot->quantity }}">
                                        </td>
                                        <td class="product-price">
                                            {{number_format($product->unit_price * $product->pivot->quantity, 2)}} $
                                        </td>
                                        <td>
                            ...
                            <div class="d-flex justify-content-end mb-3">
                                ...
                                <input type="number" class="total-price form-control mx-3"
                                    value="{{ $order->total_price }}" style="width: 100px" name="total_price">
                                <span class="my-auto">$</span>
                            </div>
